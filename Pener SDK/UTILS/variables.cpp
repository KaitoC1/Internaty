...
namespace SETTINGS
{
	...
	{
		std::string file_path = "C:\\Internaty configs\\" + file_name + ".cfg";
	...
	{
		CreateDirectory("C:\\Internaty configs", NULL);
	...
	{
		std::string file_path = "C:\Internaty configs\\BlankConfig.cfg";
	...
	std::vector<std::string> CSettings::GetConfigs()
	{
		...
		WIN32_FIND_DATA ffd;
		auto directory = "C:\\Internaty configs\\*";
