...
namespace MENU
{
	namespace PPGUI_PP_GUI
	{
		...
		constexpr int OBJECT_PADDING = 6; // this is the padding between objects
		constexpr int OBJECT_HORIZONTAL_PADDING = 18; // this is the horizontal padding between objects on the same line
		...
		constexpr int SEPARATOR_TEXT_OFFSET = 28; // how far away from the start of the line the text is
		...
		constexpr int TAB_HEIGHT = 15;

		constexpr int VERTICAL_TAB_WIDTH = 325; // width
		constexpr int VERTICAL_TAB_HEIGHT = 17; // height of a single item
